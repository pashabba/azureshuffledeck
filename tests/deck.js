...
Test('/deck', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test get_deck get operation', function (t) {
            Mockgen().requests({
                path: '/deck',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/deck']['get']['responses']['200']['schema']);
         ...
         * responses: 200, default
         */
        t.test('test addDeck post operation', function (t) {
            Mockgen().requests({
                path: '/deck',
                operation: 'post'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    t.ok(res.statusCode === 200, 'Ok response status');
                    var Validator = require('is-my-json-valid');
                    var validate = Validator(api.paths['/deck']['post']['responses']['200']['schema']);
                    var response = res.body;
                    if (Object.keys(response).length <= 0) {
                        response = res.text;
                    }
         ...
         */
        t.test('test delete_deck delete operation', function (t) {
            Mockgen().requests({
                path: '/deck',
                operation: 'delete'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var Validator = require('is-my-json-valid');
                    var validate = Validator(api.paths['/deck']['delete']['responses']['204']['schema']);
                    var response = res.body;
                    if (Object.keys(response).length <= 0) {
                        response = res.text;
                    }
