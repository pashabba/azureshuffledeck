...
class TestStringMethods(unittest.TestCase):
    ...
    def test_no_deck(self):
        ...
        self.assertTrue(s.get("http://shuffledeck.azurewebsites.net/deck/pop").text == '{"deck":[],"dealt":[]}')
...
#         
    ...
    #     s_get = json.loads(s.get("http://shuffledeck.azurewebsites.net/deck").text)
    #     print s_pop
    #     self.assertTrue(s_pop['last card popped'] == [s_get['dealt'][-1]],  msg="should not throw an error")
         
    #     s_get = json.loads(s.get("http://shuffledeck.azurewebsites.net/deck").text)
    #     self.assertTrue(len(s_get['deck']) == len(s_json)-1)
    #     self.assertTrue(len(s_get['last card popped']) == 1)
