...
#         s = requests.Session()
#         s_json = []
#         print s.post("http://shufflecards.azurewebsites.net/deck", json=s_json).text
#         self.assertTrue(s.post("http://shufflecards.azurewebsites.net/deck", json=s_json).text == '{"deck":[]}')
#         self.assertTrue(s.get("http://shufflecards.azurewebsites.net/deck").text, '{"deck":[]}')
...
#         self.assertTrue(len(s.get("http://shufflecards.azurewebsites.net/deck/shuffle").text) == len('[1,2,3,4,5,6,7]'),  msg="should not throw an error")
